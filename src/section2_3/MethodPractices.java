...
public class MethodPractices {
	...
	System.out.println("You've succesfully logged in with this username \"" + username + "\"" + " and password \"" + password + "");	
}
	...
	public static void unreadEmailGenerator() {
		...
		int emails = (int) (Math.random() * 100);		
		System.out.println("You have " + emails + " emails.");
		...
		int unReadEmails = emails - readEmails;
		System.out.println("You still have " + unReadEmails + " unread emails.");
