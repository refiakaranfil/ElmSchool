...
public class AmazonInterviewQuestion {
	...
	public static void main(String[] args) {
		...
		int [] temperatures = {0, 5, -1, 3, 7, 5, 7, 8, 10, 11, 9};
		
		for (int i = 1; i < temperatures.length; i++) {
			
			int [] winterDays = Arrays.copyOf(temperatures, i); // 0
			int [] summerDays = Arrays.copyOfRange(temperatures, i, temperatures.length); // [5, -1, 3, 7, 5, 7, 8, 10, 11, 9]
